...
def get_student_info(student_dict):
    pairs_student_age = [(id, student['age']) for id, student in student_dict.items()]
    hobbies = {
        interest
        for student in student_dict.values()
        for interest in student['interests']
    }
    total_len_surname = sum(
        len(student['surname']) for student in student_dict.values())

    return pairs_student_age, hobbies, total_len_surname


pairs_student_age, hobbies, total_len_surname = get_student_info(students)
